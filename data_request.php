...
if($network == "MTN"){
	...
	//////////////////////////////////////////// END MANUAL RECHARGIN//////////////////////////////
		
	

		//////////////////////////////////////////////////////////////////////////////////////
	if(substr($data_plan, 0,11) == 'Gifting 1GB'){
		$price = 300;
		$datasize1 = 1000;
		$datasize2 = "";

	}else if(substr($data_plan, 0,11) == 'Gifting 2GB'){
		$price = 600;
		$datasize1 = 2000;
		$datasize2 = "";
		
	}else if(substr($data_plan, 0,11) == 'Gifting 3GB'){
		$price = 900;
		$datasize1 = 3000;
		//$datasize2 = 1000;
	...
	}else if(substr($data_plan, 0,11) == 'Gifting 5GB'){
		$price = 1450;
		$datasize1 = 5000;
		$datasize2 ="";
		
	}else if(substr($data_plan, 0,3) == '1GB'){
		$price = 340;
		$datasize1 = 1000;
		$datasize2 = "";
	...
	if($num_row == 1){
  	...
  	if(
	substr($data_plan, 0,11) == "Gifting 1GB"||
	substr($data_plan, 0,11) == "Gifting 2GB"||
	substr($data_plan, 0,11) == "Gifting 3GB"||
	substr($data_plan, 0,11) == "Gifting 5GB"||
